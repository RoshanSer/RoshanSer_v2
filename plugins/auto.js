...
r_text[1] = "Roshan tholpikkaan ningalkavilla. Jeevitathil Roshan tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Roshan says thank you for using RoshanSer Bot";
r_text[3] = "Roshanserdeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Enne ninte friendsin parichayapeduthi kodukk";
r_text[7] = "താനാരാണെന്ന് തനിക്ക് അറിയാന്‍ മേലങ്കില്‍താന്‍ എന്നോട്‌ ചോദിക്ക്.. താനാരണെന്ന്...തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്ന്...എന്നിട്ട്‌ഞാനാരാണെന്ന് എനിക്കാറിയാമൊന്നുതാനെന്നോട്‌ ചോദിക്ക്..അപ്പോ തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്നും ..ഞാനാരാണെന്നും";
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per RoshanSer,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Roshan";
...
r_text[13] = ".song adich thangalude fav song name para RoshanSer ath download aakki theraam";
...
r_text[18] = "enikk njan und RoshanSer uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe RoshanSer pazhaya RoshanSer thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik RoshanSer";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. RoshanSer";
r_text[24] = "\nVarrierey… Enthado njan inganey aayi poyathu\n";
r_text[25] = "\nhttps://chat.whatsapp.com/KequP491eI1IVVipViyWQP Ee groupil illenkil join cheyyu😇\n";
