...
module.exports = {
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '💘Rᴏsʜᴀɴ Sᴇʀ💘' : process.env.BOT_NAME,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Roshan' : process.env.TAG_HEADER,
    GRPLINK: process.env.SUPPORT_LINK === undefined ? 'https://chat.whatsapp.com/KequP491eI1IVVipViyWQP' : process.env.SUPPORT_LINK,
